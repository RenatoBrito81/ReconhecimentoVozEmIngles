...
function sortearCor(){
    ...
    var nomeCorSorteada = engine.cores[indiceCorSorteada];
    legendaCorDaCaixa.innerText = nomeCorSorteada.toUpperCase();
    var corSorteada = engine.cores[indiceCorSorteada];
...
if(window.SpeechRecognition || window.webkitSpeechRecognition){
    ...
    gravador.onresult = function(evento){
        transcricaoAudio = evento.results[0][0].transcript.toUpperCase();
